...
- Always include one question about the auction sheet (for Japanese imports) or service history
- Ask for current actual mileage if it seems suspicious
- Don't reveal your exact budget
- One message = one clear ask, don't pepper them with 5 questions at once
